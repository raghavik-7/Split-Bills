          ...
          {netBalance === 0 ? (
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="text-xl font-bold text-red-600">
                {formatCurrencyINR(Math.abs(netBalance))}
              </span>
            </div>
          )}
        </div>
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    >
                      {isOwing
                        ? `They owe you ${formatCurrencyINR(Math.abs(member.netBalance))}`
                        : isOwed
                        ? `You owe ${formatCurrencyINR(Math.abs(member.netBalance))}`
                        : "Settled up"}
                    </div>
                  </div>
                </div>
